...
always@*
 casex (ca[7:2])
	...
	6'b001000: iodo<= spidat;	//ASIGNAMOS LA DIRECCION 0xE000020
	6'b001001: iodo<= spictl;   //Asigno la dirección 0xE000024 a la señal nueva de control del SPI 
...
always @(posedge clk) // Quitar esto: assign spiwr = spics; 
	begin
		if (spiwr) // Y poner más condiciones aquí usando los bits menos significativos también
			begin
				spictl <= cdo[13:0];
			end
	end
